...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
  ...
  echo "Error: $OSTYPE not supported" && false
fi
...
# This isn't necessary anymore because it looks like neovim is in the package for ubuntu 20.04
# TODO detect if neovim is right version or something... in apt
